...
import 'package:movies_apis_app/View/desktop/deskfavourite.dart';

class DesktHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: ScreenSize.screenWidth(context) * .1,
          ...
          children: [
            Positioned(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  height: ScreenSize.screenWidth(context) * .08,
                  child: Image.asset(
            ...
            Positioned(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Deskfav()),
                  );
                },
                icon: Icon(
                  Icons.favorite,
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.aBeeZee(
                    fontSize: ScreenSize.screenWidth(context) * .028,
                  ),
                ),
                SizedBox(
                ...
                Padding(
                  padding:  EdgeInsets.symmetric(horizontal: ScreenSize.screenWidth(context)*.2),
                  child: InkWell(
                    onTap: () {},
                    child: MyCarouselSlider(
                      heiight: ScreenSize.screenWidth(context)*.4,
                ...
                Padding(
                  padding:  EdgeInsets.symmetric(horizontal: ScreenSize.screenWidth(context)*.2),
                  child: MyCarouselSlider(
                   heiight: ScreenSize.screenWidth(context)*.25,
